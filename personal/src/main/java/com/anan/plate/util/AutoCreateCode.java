...
public class AutoCreateCode {
	...
	static String project = "F:/20098780/personal1/";
	...
	static String[] templates = { "Dao.java", "DaoImpl.java",
			...
			"Domain.java" };
	static String packageName = "src/main/java/com/itly/plate/";
	static String testPackageName = "src/test/java/com/itly/plate/";
	...
	// 实体的名称
	static String[] entitys = {"Music"};
	// 功能名称
	static String[] functionName = {"music"};
	// 额外包名称
