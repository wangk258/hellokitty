...
(function ($) {
    function _1(_2) {
        ...
        $("<span style=\"padding-right:6px;padding-left:10px;\"></span>").wrap("<td></td>").parent().appendTo(tr);
        $("<td><div class=\"pagination-btn-separator\"></div></td>").appendTo(tr);
    ...
    $.fn.pagination.defaults = {total: 1, pageSize
        : 10, pageNumber: 1, pageList: [10, 20, 30, 50], loading: false, buttons: null, showPageList: true, showRefresh: true, onSelectPage: function (_1e, _1f) {
    }, onBeforeRefresh: function (_20, _21) {
    }, onRefresh: function (_22, _23) {
    }, onChangePageSize: function (_24) {
    }, beforePageText: "第", afterPageText: "页&nbsp;共{pages}页", displayMsg: "共 {total} 条"};
})(jQuery);
