...
<script type="text/javascript"
	src="${ctx}/js/admin/process/processlist.js"></script>
</head>
<body>
		...
		<form id="addForm" method="post" enctype="multipart/form-data">
			...
			<div class="datagrid-toolbar mytoolbar">
				<span><a href="#" class="easyui-linkbutton"
					...
					onclick="addMethod(this)" url="process/add.ajax" id="saveA">保存</a>
				</span> <span><a href="#" class="easyui-linkbutton"
					data-options="iconCls:'icon-detail',plain:true"
					onclick="viemMethod(this)" url="process/process.php">预览</a>
				</span>
