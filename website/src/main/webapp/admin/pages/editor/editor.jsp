	...
	<div id="addDiv">
		<form id="addForm" method="post" enctype="multipart/form-data">
			<input type="hidden" name="id" id="id" /> <input type="hidden"
				...
				name="pkey" id="pkey" value="${param.pkey }" /> <input type="hidden"
				name="page" id="page" value="${param.pageFlag }" />
			...
			<div class="datagrid-toolbar mytoolbar">
				<span><a href="#" class="easyui-linkbutton"
					...
					onclick="viemMethod(this)"
					url="editor/rainbow.php?ckey=${param.ckey}&pkey=${param.pkey}&page=${param.pageFlag}">预览</a>
				</span>
