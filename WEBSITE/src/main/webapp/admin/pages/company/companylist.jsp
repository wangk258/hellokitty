...
<script type="text/javascript"
	src="${ctx}/js/admin/company/companylist.js"></script>
...
<body class="easyui-layout">
	<div id="toolbarDiv">
		...
		<a href="#" class="easyui-linkbutton"
			...
			onclick="editMethod(this)" url="company/edit.ajax">修改</a>
	...
	<div id="addDiv" style="display: none">
		<form id="addForm" method="post" enctype="multipart/form-data">
			...
			<input name="imageUrl" type="hidden" id="imageUrlHidden" /> <input
				name="id" type="hidden" />

			<table>
				<tr>
					<td class="tdTitle"><label for="name">维护项:</label></td>
					<td><input class="easyui-validatebox" type="text" name="item"
						data-options="required:true,length:[5,20]" disabled="disabled" />
					</td>
				</tr>
				<!--  	<tr>
				...
				<tr>
					...
					<td><input class="easyui-validatebox" type="text"
						name="content" data-options="required:true,length:[5,20]" /></td>
				</tr>
			</table>
