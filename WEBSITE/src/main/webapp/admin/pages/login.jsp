...
<title>登录</title>
<link href="/admin/pages/login/css/base.css" rel="stylesheet" type="text/css">
<link href="/admin/pages/login/css/login.css" rel="stylesheet" type="text/css">
...
<form action="" method="post" id="loginForm">
	<div class="logo_img"><img src="/images/front/logo.png"/></div>
	<div class="logo"></div>
    ...
    <div id="tip"></div>
    <div class="note">
    	本系统由HTML5开发，推荐使用IE9+，FireFox，Chrome浏览器浏览使用！
    </div>
    <div class="foot">
		${companyInfo.beian.content }
    </div>
    </form>
</div>
</body>
